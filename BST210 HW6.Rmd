...
plot(na.omit(dt$age), mage.fitted[,1], type = "l", col = "red", 
     ylim = c(0,1), ylab = "Probability of Outcome", xlab = "Age",
     main = "Fitted Values, o1 = Red, o2 = Blue, o3 = Green")
lines(na.omit(dt$age), mage.fitted[,2], type = "l", col = "blue")
lines(na.omit(dt$age), mage.fitted[,3], type = "l", col = "green")
